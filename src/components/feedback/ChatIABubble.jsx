...
export default function ChatIABubble({
  ...
  return (
    <>
      ...
      {shouldRenderChat && (
        <div
          className={`fixed bottom-20 right-3 sm:bottom-24 sm:right-6 z-50 rounded-3xl border-0 shadow-2xl shadow-black/80 flex flex-col overflow-hidden select-text origin-bottom-right transition-all duration-240 ease-out ${
            isMaximized
              ? "w-[calc(100vw-1.5rem)] sm:w-[min(880px,calc(100vw-2rem))] h-[calc(100dvh-110px)]"
              : "w-[calc(100vw-1.5rem)] sm:w-[440px] h-[560px] max-h-[calc(100dvh-110px)] min-h-[340px]"
          } ${
